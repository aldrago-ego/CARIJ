...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Montserrat:wght@300;400;500;600&display=swap"
    rel="stylesheet">

  <title><?= $SITE_NAME ?></title>
  <meta name="description"
    content="Le CARIJ est un organe technique et stratégique qui accompagne l’État dans la modernisation de la justice et les réformes institutionnelles au Togo." />
...
<body>
  ...
  <header class="nav" id="navbar">
    <div class="nav-inner">
      <a href="#accueil" class="brand">
        ...
        <div class="brand-tagline">Comitéalfa d’Appui aux Réformes<br />Institutionnelles et Juridictionnelles</div>
      </a>
      ...
      <div class="hero-content container">
        <div class="hero-card">
          ...
          <p class="hero-subtitle">
            Soutenir l'État, structurer les réformes et promouvoir les droits humains à travers l'expertise et la
            facilitation institutionnelle.
          </p>
          <div class="cta-row">
      ...
      <div class="container">
        <div class="about-grid">
          <div class="about-text">
            ...
            <p>Basé à Lomé, le <strong>CARIJ</strong> est un organe d'appui gouvernemental et un Think tank actif dans
              les réformes du système judiciaire togolais.</p>
            <p>Notre mission n'est pas de légiférer ou de juger, mais de structurer l'avenir de la justice en proposant
              des politiques publiques basées sur des études minutieuses.</p>

            <ul class="mission-list mt-4">
              <li><span class="icon">🏛️</span> <strong>Améliorer</strong> le fonctionnement de la justice</li>
              <li><span class="icon">⚖️</span> <strong>Accompagner</strong> les réformes institutionnelles et
                juridictionnelles</li>
      ...
      <div class="container">
        ...
        <div class="domains-grid">
          <div class="domain-card-legal">
            ...
            <div class="card-body">
              <p>Apporter des solutions techniques pour pallier la lenteur de la justice et favoriser l'accessibilité
                aux droits pour l'ensemble des citoyens.</p>
            </div>
          </div>
          ...
          <div class="domain-card-legal">
            ...
            <div class="card-body">
              <p>Analyse et appui à la refonte des institutions étatiques pour garantir une administration juste,
                efficace et conforme aux conventions des droits.</p>
            </div>
          </div>
          ...
          <div class="domain-card-legal">
            ...
            <div class="card-body">
              <p>Lutte contre la surpopulation carcérale, accompagnement de la réinsertion sociale et études visant à
                faire reculer le taux de récidive.</p>
            </div>
          </div>
          ...
          <div class="domain-card-legal">
            ...
            <div class="card-body">
              <p>Consultations régulières, coordination d'ateliers multi-acteurs et publication d'études chiffrées
                stratégiques (ex: sur la récidive).</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="contact-wrapper">
          <div class="contact-info-legal bg-navy text-white">
            ...
            <div class="separator-gold-left"></div>
            <p class="mt-4">
              Le CARIJ se tient à la disposition des institutions, ONG et partenaires pour collaborer et fournir son
              expertise technique.
            </p>
            ...
            <ul class="contact-list mt-5">
              ...
              <li>
                ...
                <div>
                  ...
                  <p><a href="tel:<?= str_replace(' ', '', $CONTACT_PHONE) ?>"
                      class="text-white"><?= $CONTACT_PHONE ?></a></p>
                </div>
              </li>
              <li>
          ...
          <div class="contact-form-legal">
            ...
            <p class="mb-4 text-muted">Veuillez remplir ce formulaire pour toute demande d'assistance technique ou
  ...
  <div id="cookie-banner" class="cookie-banner-legal">
    <div class="container d-flex align-items-center justify-content-between alert-box">
      <p>
        Veuillez noter que l'association CARIJ utilise des cookies strictement à des fins d'amélioration de la
        navigation. <a href="politique-confidentialite.php" target="_blank">En savoir plus</a>
      </p>
